...
import { BSBService, BSBServiceConstructor, BSBPluginEvents, DTrace, ServiceClient, BSBServiceClientDefinition } from "@bettercorp/service-base";
...
export class Plugin
  ...
  public override async run(trace: DTrace) {
    ...
    const bench = benchmark.createSuite("Call local actions", { time: 30000 });
